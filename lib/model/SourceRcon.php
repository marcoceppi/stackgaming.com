...
class SourceRconException extends Exception
{
...
class SourceRcon
{
	...
	public function Connect( $Ip, $Password, $Port = 25575, $Timeout = 3 )
	{
		$this->RequestId = 0;
		...
		if( $this->Socket = FSockOpen( $Ip, (int)$Port ) )
		{
			...
			if( !$this->Auth( $Password ) )
			{
				...
				throw new SourceRconException('Authorization failed.');
			}
		}
		else
		{
			throw new SourceRconException('Can\'t open socket.');
		}
	}
